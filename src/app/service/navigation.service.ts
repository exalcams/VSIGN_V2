...
export class FuseNavigationService
{
    ...
    private _currentNavigationKey: string |any;
     ...
     * @param navigation
     */
    register(key: string | number, navigation: any): void
    {
     ...
     * @returns {any}
     */
    getNavigation(key: string | number): any
    {
        // Check if the navigation exists
        if ( !this._registry[key] )
        {
     ...
     * @returns {any[]}
     */
    getFlatNavigation(navigation: any, flatNavigation: NavItem[] = []): any
    {
     ...
     * @param key
     */
    setCurrentNavigation(key: string | number): void
    {
     ...
     * @returns {any | boolean}
     */
    getNavigationItem(id: string, navigation :any): any | boolean
    {
        if ( !navigation )
        {
     ...
     * @param parent
     */
    getNavigationItemParent(id: any, navigation : any, parent = null): any
    {
        if ( !navigation )
        {
            navigation = this.getCurrentNavigation();
    ...
    addNavigationItem(item: any, id: string): void
    {
        ...
        const parent: any = this.getNavigationItem(id,navigation);
    ...
    {
        const item = this.getNavigationItem(id,navigator);
        ...
        let parent = this.getNavigationItemParent(id,navigator);
